...
//    //… where x.name = ?1 or x.email = ?2
    Optional<User> findUsersByNameOrEmail(String name, String email);
//
...
//
//    //… where x.age = ?1 order by x.lastname desc
//    List<User> findByNameContainingOrderByIdDesc(String name); new com.fundamentosplatzi.springboot.fundamentos.dto.UserDto(u.id,u.name,u.birthDate)
